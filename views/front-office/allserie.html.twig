    ...
    <div id="tvshows-slider">
        <div>
            <a href="movie-details.html">
                <div class="shows-img">
                    <img src="../public/images/movie-banner/1.jpg" class="w-100" alt="">
        ...
        <div>
            <a href="movie-details.html">
                <div class="shows-img">
                    <img src="../public/images/movie-banner/2.jpg" class="w-100" alt="">
                    <div class="shows-content">
        ...
        <div>
            <a href="movie-details.html">
                <div class="shows-img">
                    <img src="../public/images/movie-banner/3.jpg" class="w-100" alt="">
                    <div class="shows-content">
            ...
            <div class="row">
                <div class="col-sm-12 overflow-hidden">
                    ...
                    <div class="d-flex justify-content-evenly flex-wrap">
                        ...
                        <div class="b-block ml-3 mr-3 mb-5 video-items" data-slick-index="0" aria-hidden="false" style="width: 432px;" tabindex="0" style="">
